...
<c:set var="houseUnitId"
	value='<%=request.getAttribute("houseUnitId")%>' />
...
<body>
	...
	<c:if test="${!empty community}">
		<div class="col-md-12 ">
			<div class="portlet box iframe-box ">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-reorder"></i>设置单元信息
					</div>
					<div class="actions">
						<a id="data_table_new_btn" class="btn iframe-btn"
							onclick="HouseUnit.addInfo();"><i
		...
		<div id="modalHouseUnit" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true"></button>
						<h4 id="modalHouseUnitTitle" class="modal-title">单元设置</h4>
					</div>
					<div class="modal-body">
						<f:form class="community-form form-validate  form-horizontal"
							action="${ctx}/house/houseUnit" method="post"
							commandName="houseUnitCommand" id="editForm">
							...
							<div class="form-body">
								<div
									...
									<label class="control-label  col-md-2">单元号</label>
									<div class="col-md-8">
										<f:input class="form-control required" type="text"
											autocomplete="off" placeholder="单元号" path="name" />
									</div>
	...
	<![endif]-->
		...
		<script type="text/javascript"
			src="<c:url value='/assets/scripts/pages/houseUnit.js'/>"></script>
