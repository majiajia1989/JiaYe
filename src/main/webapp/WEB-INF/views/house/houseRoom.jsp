...
<c:set var="houseRoomId"
	value='<%=request.getAttribute("houseRoomId")%>' />
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<body>
	...
	<c:if test="${!empty community}">
		<div class="col-md-12 ">
			<div class="portlet box iframe-box ">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-reorder"></i>设置门牌信息
					</div>
					<div class="actions">
						<a id="data_table_new_btn" class="btn iframe-btn"
							onclick="HouseRoom.addInfo();"><i
		...
		<div id="modalHouseRoom" class="modal fade" tabindex="-1"
			data-width="760">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 id="modalHouseRoomTitle"  class="modal-title">门牌号设置</h4>
					</div>
					<div class="modal-body">
						<f:form class="commRoomy-form form-validate  form-horizontal"
							action="${ctx}/house/houseRoom" method="post"
							commandName="houseRoomCommand" id="editForm">
							<input type="hidden" id="corpId" name="corpId" value="${corpId}" />
							<input type="hidden" id="communityId" name="communityId"
								value="${communityId}" />
							<input type="hidden" id="houseRoomId" name="houseRoomId"
								value="${houseRoomId}" />
							<input type="hidden" id="houseUnitId" name="houseUnitId"
								value="${houseRoomId}" />
							...
							<div class="form-body">
								<div
									...
									<div class="col-md-8">
										<f:input class="form-control required" placeholder="门牌号"
											path="name" />
									</div>
	...
	<![endif]-->
		...
		<script type="text/javascript"
			src="<c:url value='/assets/scripts/pages/houseRoom.js'/>"></script>
