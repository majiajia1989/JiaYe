...
<body>
	...
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i>代办事务类型管理
				</div>

				<div class="actions">
					<a id="data_table_new_btn" class="btn iframe-btn"
						data-toggle="modal" href="#"
						onclick="javascript:CommissionTypes.openTypeModal();"><i
						class="fa fa-plus"></i>&nbsp;新&nbsp;建</a>
				</div>
			</div>
			<div class="portlet-body">
				<table class="table table-striped table-hover table-bordered"
					id="commissiontype_table">
	...
	<div id="type_modal" class="modal fade bootstrap-dialog type-primary "
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="bootstrap-dialog-title">添加事务类型</h4>
				</div>
				<div class="modal-body">
					<f:form class="form-validate  form-horizontal"
						action="${ctx}/commission/saveCommissionType" method="post"
						id="type-form" commandName="commissionTypeCommand">
						...
						<div class="form-body">
							<div
								...
								<label class="control-label  col-md-2">事务类型</label>
								<div class="col-md-8">
									<f:input class="form-control required" placeholder="事务类型"
										id="input_type" path="name" />
								</div>
				...
				<div class="modal-footer">
					<button class="btn iframe-btn" type="button" id="type-submit-btn">
	...
	<div id="deleteType-modal"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn iframe-btn" type="button" id="deleteType-btn">
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/commissionTypes.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			CommissionTypes.init("<c:url value='/' />");
		});
	</script>
	<!-- END JAVASCRIPTS -->
	</c:if>
