...
<c:set var="creatorCorpType"
	value='<%=request.getAttribute("creatorCorpType")%>' />
<c:set var="creatorCorpID"
	value='<%=request.getAttribute("creatorCorpID")%>' />
...
<c:if test="${!empty userCommand}">
	...
	<c:set var="corpType" value="${userCommand.type}" />
...
<body>
			...
			<div class="portlet-title col-md-12">
				...
				<div class="actions">
					<a id="data_table_new_btn" class="btn iframe-btn btn-return"
						href="${ctx}/user/corpUser"><i class="fa fa-chevron-left"></i> 返 回 </a>
				</div>
			</div>
			<div class="portlet-body form">
				<!-- 内容区域开始-->
				<f:form class="corp-form form-validate  form-horizontal"
					action="${ctx}/user/saveCorpUser" method="post"
					...
					<div class="form-body">
						...
						<div
							class="form-group <f:errors path="corpName">has-error</f:errors>">
							<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
							<label class="control-label  col-md-2">单位名称</label>
							<div class="col-md-8">
								<f:input class="form-control required" placeholder="单位名称"
									path="corpName" />
							</div>
							<label class="control-label"><span class="required">*</span></label>
							<f:errors cssClass="help-block" element="span" path="corpName" />
						</div>
						<div
					...
					<div class="form-actions fluid">
						<div class="col-md-5 col-md-offset-2 pull-left">
							<button class="btn iframe-btn" type="submit"><i class="fa fa-check"></i>&nbsp;保&nbsp;存</button>
						</div>
					</div>
				</f:form>
				<!--内容区域结束-->
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/editCorpUser.js'/>"></script>
