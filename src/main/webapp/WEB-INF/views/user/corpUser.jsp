...
<body>
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i>企业信息
				</div>
				<div class="actions">
					<a id="data_table_new_btn" class="btn iframe-btn"
						href="${ctx}/user/editCorpUser/-1"><i class="fa fa-plus"></i>&nbsp;新&nbsp;建
					</a>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/corpUser.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			CorpUser.init("<c:url value='/' />");
		});
	</script>
	<!-- END JAVASCRIPTS -->
</body>
