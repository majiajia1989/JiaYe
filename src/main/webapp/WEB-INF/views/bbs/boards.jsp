...
<link type="text/css" rel="stylesheet" href="<c:url value='/assets/plugins/bootstrap-toastr/toastr.css'/>" />
<!-- END THEME STYLES -->
<!-- BEGIN PAGE LEVEL STYLES -->
<link type="text/css" rel="stylesheet" href="<c:url value='/assets/plugins/data-tables/DT_bootstrap.css'/>" />
...
<body>
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i>论坛板块志
				</div>
				<div class="tools">
					<select id="board-type">
						<option value="0">全部板块</option>
						<option value="1">可用板块</option>
						<option value="2">禁用板块</option>
					</select>
				</div>
			</div>
	...
	<script type="text/javascript" src="<c:url value='/assets/plugins/bootbox/bootbox.min.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/assets/plugins/bootstrap-toastr/toastr.min.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/assets/scripts/app.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/assets/scripts/pages/boards.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			Boards.init("<c:url value='/' />");
		});
	</script>
	<!-- END JAVASCRIPTS -->
</body>
