...
<body>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-search"></i>&nbsp;查询条件</h4>
					</div>
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							...
							<input type="hidden" id="queryCommunityId"
								...
								value="2" /> <input type="hidden" id="queryPayNumber"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true"></button>
						<h4 class="modal-title"><i class="fa fa-sign-in"></i>&nbsp;导入</h4>
					</div>
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							action="${ctx}/consumeInfo/importConsumeInfo" method="post"
							...
							<input type="hidden" id="importCommunityId"
								...
								name="importConsumeTypeId" value="2" />
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary"
							onclick="Water.submitImportForm();">
							<i class="fa fa-sign-in"></i>&nbsp;导&nbsp;入
						</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">
							<i class="fa fa-times"></i>&nbsp;关&nbsp;闭
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true"></button>
						<h4 class="modal-title"><i class="fa fa-envelope"></i>&nbsp;发送微信</h4>
					</div>
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							...
							<input type="hidden" id="sendCommunityId" name="sendCommunityId"
								...
								id="sendConsumeTypeId" name="sendConsumeTypeId" value="2" /> <input
	...
	<![endif]-->
		...
		<script type="text/javascript"
			src="<c:url value='/assets/scripts/pages/water.js'/>"></script>
