...
<body>
		...
		<div class="col-md-12 ">
			<div class="portlet box iframe-box ">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-reorder"></i>电费模板信息
					</div>
					<div class="actions">
						<button id="data_table_new_btn" class="btn iframe-btn"
							data-toggle="modal" onclick="ElectricityTemplate.addInfo();">
				...
				<div class="modal-content">
										...
										<div
											...
											<div class="col-md-9">
												<f:textarea type="text" class="form-control required"
													style="height:247px;" placeholder="模板内容" path="content" id="content"></f:textarea>
											</div>
										...
										<div class="btn-group dropdown open"
											...
											<ul class="dropdown-menu" role="menu" align="left"
												...
												<li><a style="line-height: 8px;" 
													onclick="ElectricityTemplate.insertFiled('年份')">年份</a></li>
												<li><a style="line-height: 8px;" 
													onclick="ElectricityTemplate.insertFiled('月份')">月份</a></li>
												<li><a style="line-height: 8px;" 
													onclick="ElectricityTemplate.insertFiled('小区名称')">小区名称</a></li>
												<li><a style="line-height: 8px;" 
													onclick="ElectricityTemplate.insertFiled('楼号')">楼号</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('单元')">单元</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('楼层')">楼层</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('门牌号')">门牌号</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('户号')">户号</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('抄表时间')">抄表时间</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('上期表数')">上期表数</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('本期表数')">本期表数</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('本期用量')">本期用量</a></li>
												<li><a style="line-height: 8px;"
													onclick="ElectricityTemplate.insertFiled('应缴金额')">应缴金额</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="modal-footer" style="overflow: visible">
						<button type="button" class="btn btn-primary"
							onclick="ElectricityTemplate.submitForm();">
	...
	<![endif]-->
		...
		<script type="text/javascript"
			src="<c:url value='/assets/scripts/pages/electricityTemplate.js'/>"></script>
		...
		<script>
			$(function() {
				...
				ElectricityTemplate.init("<c:url value='/' />");
			});
		</script>
	</c:if>
	<!-- END JAVASCRIPTS -->
