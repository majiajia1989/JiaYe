...
<body>
					...
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							...
							<input type="hidden" id="queryCommunityId"
								...
								value="3" /> <input type="hidden" id="queryPayNumber"
					...
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							...
							<input type="hidden" id="importCommunityId"
								...
								name="importConsumeTypeId" value="3" />
					...
					<div class="modal-body">
						<form class="form-validate  form-horizontal"
							...
							<input type="hidden" id="sendCommunityId" name="sendCommunityId"
								...
								id="sendConsumeTypeId" name="sendConsumeTypeId" value="3" /> <input
	...
	<![endif]-->
		...
		<script type="text/javascript"
			src="<c:url value='/assets/scripts/pages/gas.js'/>"></script>
