...
<body>
	...
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title col-md-12">
				<div class="caption">
					<i class="fa fa-edit"></i>添加小区图片
				</div>
				<div class="actions">
					<button type="button" class="btn iframe-btn btn-return"
						onclick="Javascript:{window.location='${ctx}/community/communityImage';}">
			...
			<div class="portlet-body form">
				<f:form role="form" class="form-horizontal form-validate"
					name="image-form" method="post" action="${ctx}/community/addCommunityImage"
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<button id="show-child-btn" class="btn iframe-btn"
									data-toggle="modal" onclick="javascript:AddCommunityImage.response(${ctx}/)">
	...
	<div class="modal fade bootstrap-dialog type-primary "
		id="communityimage-modal" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/addCommunityImage.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			AddCommunityImage.init("<c:url value='/' />");
		});
	</script>
	</c:if>
	<!-- END JAVASCRIPTS -->
