...
<link type="text/css" rel="stylesheet"
	href="<c:url value='/assets/css/pages/notices.css'/>" />
...
<body>
	...
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i>通知信息
				</div>
				<div class="actions">
					<a id="data_table_new_btn" class="btn iframe-btn"
						href="${ctx}/community/editNotice/-1"><i class="fa fa-plus"></i>
						&nbsp;新&nbsp;建 </a>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/notices.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			Notices.init("<c:url value='/' />");
