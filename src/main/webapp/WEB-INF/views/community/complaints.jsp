...
<link type="text/css" rel="stylesheet"
	href="<c:url value='/assets/css/pages/complaints.css'/>" />
...
<body>
	...
	<div class="col-md-12 ">
		<div class="portlet box iframe-box ">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i>投诉建议信息汇总
				</div>
			</div>
			<div class="portlet-body">
				<div class="form-group complaints">
					<div class="pull-left">
						<label class="control-label pull-left">是否匿名提交：</label>
						<div class="pull-left">
							<select class="border-grey textwidth" id="anonymous-select">
								<option value="0">不限</option>
								<option value="1">是</option>
								<option value="2">否</option>
							</select>
						</div>
						<label class="pull-left control-label" style="margin-left: 20px;">回复情况：</label>
						<div class="pull-left">
							<select class="border-grey textwidth" id="responsed-select">
								<option value="0">不限</option>
								<option value="1">已回复</option>
								<option value="2" selected="selected">未回复</option>
							</select>
						</div>
					</div>
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/complaints.js'/>"></script>
