...
<body class="editNotice">
		...
		<div class="portlet box iframe-box">
			<div class="portlet-title col-md-12">
				<div class="caption col-md-2">
					...
					<c:if test="${noticeCommand.id eq -1}">添加通知</c:if>
					<c:if test="${noticeCommand.id ne -1}">编辑通知</c:if>
				</div>
			...
			<div class="portlet-body form">
				<f:form class="editNotice-form form-horizontal form-validate"
					name="example" method="post" action="${ctx}/community/saveNotice"
					commandName="noticeCommand">
					<f:input class="form-control" type="hidden" path="id"
						name="id" />

					<div class="form-body">
						
						<div class="form-group <f:errors path="title">has-error</f:errors>">
						...
						<div class="form-group <f:errors path="content">has-error</f:errors>">
						...
						<div class="form-group <f:errors path="pictureUrl">has-error</f:errors>">
							...
							<div class="col-md-8">
								...
								<f:input type="hidden" name="pictureUrl" id="pictureUrl"
									class="form-control" path="pictureUrl" />
							</div>
							<f:errors cssClass="help-block" element="span" path="pictureUrl" />
						</div>						
						<div class="form-group <f:errors path="description">has-error</f:errors>">
	...
	<script type="text/javascript"
		src="<c:url value='/assets/scripts/pages/editNotice.js'/>"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
		$(function() {
			EditNotice.init("<c:url value='/' />");
