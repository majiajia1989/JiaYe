var AddCorpImage = function() {

	var handleEdit = function(ctxUrl) {
		var uploadUrl = ctxUrl + 'kindeditor/uploadCorp';
		var filesUrl = ctxUrl + 'kindeditor/filesCorp';
	...
	var initTable = function(ctxUrl) {
		...
		var url = ctxUrl + 'message/queryAllArticlesByCorp';
		$('#article_Table')
				.dataTable(
						{
							"bServerSide" : true,
							...
							"aoColumns" : [
									...
									},
									{
										...
										"mRender" : function(data, type, full) {
											if (type == "display") {
												var selectUrl = "AddCorpImage.selectID("+ full.msgID + ", '"+ full.title +"');";
